...
installed_files := $(sort $(filter-out $(PRODUCT_OUT)/apex/% $(PRODUCT_OUT)/fake_packages/% $(PRODUCT_OUT)/testcases/%,$(filter $(PRODUCT_OUT)/%,$(modules_to_install))))
else
...
apps_only_sbom_files := $(patsubst %,%.spdx,$(apps_only_installed_files))
...
$(call dist-for-goals,apps_only,$(apps_only_sbom_files))
