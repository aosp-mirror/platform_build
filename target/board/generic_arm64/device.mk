...
PRODUCT_COPY_FILES += \
    device/google/cuttlefish_kernel/5.4-arm64/kernel-5.4-allsyms:kernel-5.4-allsyms \
    device/google/cuttlefish_kernel/5.4-arm64/kernel-5.4-gz-allsyms:kernel-5.4-gz-allsyms \
    device/google/cuttlefish_kernel/5.4-arm64/kernel-5.4-lz4-allsyms:kernel-5.4-lz4-allsyms
endif
