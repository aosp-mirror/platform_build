...
<?cs include:"trailer.cs" ?>
  ...
  <script src="<?cs var:toroot ?>jd_lists_unified.js?v=11" type="text/javascript"></script>
  <script src="<?cs var:toroot ?>jd_extras.js?v=11" type="text/javascript"></script>
  <script src="<?cs var:toroot ?>jd_collections.js?v=11" type="text/javascript"></script>
  <script src="<?cs var:toroot ?>jd_tag_helpers.js?v=11" type="text/javascript"></script>
